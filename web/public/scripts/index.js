// Copied runtime from RestAPI/wwwroot/scripts/index.js
// API Base URL
...
async function checkExistingSession() {
  try {
    await fetch(`${API_BASE}/current`, { credentials: 'include' });
  } catch (error) {}
}
...
// Expose some functions if needed by JSX events
window.playAgainSameDifficulty = playAgainSameDifficulty;
